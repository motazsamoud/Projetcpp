...
ligne::ligne(int id_l,QString depart,QString arrive,QString kilometrage,QDate date_n)
{
 this->id_l=id_l;
 this->depart=depart;
 this->arrive=arrive;
...
bool ligne::modifier(int id_l,QString depart,QString arrive,QString kilometrage)
{

       QSqlQuery query;
       QString cin_string=QString::number(id_l);
